...
const CompanyCarousel = () => {
  const logos = [...companies, ...companies]; // Duplicate for seamless scroll
  ...
  return (
    <section className="bg-primary py-10 w-full overflow-hidden">
      ...
      <div className="relative w-full overflow-hidden">
        <div className="flex w-max gap-12 animate-scrollX">
          {logos.map((company, index) => (
            <a
              ...
              className="flex flex-col items-center min-w-[150px] hover:scale-105 transition-transform"
              aria-label={`Visit ${company.name}`}
            >
              <img
                src={company.image}
