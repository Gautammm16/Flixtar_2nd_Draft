...
//     if (window.innerWidth < 768 && container && container.children.length === companies.length) {
//       companies.forEach((_, index) => {
//         const clone = container.children[index].cloneNode(true);
...
const CompanyCarousel = () => {
  ...
  return (
    ...
    >
      ...
      <div
        ref={carouselRef}
        className={`flex items-center gap-10 px-4 no-scrollbar whitespace-nowrap scroll-smooth ${
