    ...
    <footer className="bg-secondary py-12" aria-label="Website Footer">
      <div className="container mx-auto px-6 max-w-screen-xl">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10 md:gap-8 mb-12">
          ...
          {/* Social / Contact */}
          <section aria-label="Social and Contact Information">
            <h4 className="text-lg font-semibold mb-4">Connect</h4>
            <div className="flex space-x-4 mb-4">
              <a href="#" aria-label="Facebook" className="text-gray-400 hover:text-accent transition" rel="noopener noreferrer">
                <FaFacebook size={20} title="Facebook" aria-hidden="true" />
              </a>
              <a href="#" aria-label="Twitter" className="text-gray-400 hover:text-accent transition" rel="noopener noreferrer">
                <FaTwitter size={20} title="Twitter" aria-hidden="true" />
              </a>
              <a href="#" aria-label="Instagram" className="text-gray-400 hover:text-accent transition" rel="noopener noreferrer">
                <FaInstagram size={20} title="Instagram" aria-hidden="true" />
              </a>
              <a href="#" aria-label="LinkedIn" className="text-gray-400 hover:text-accent transition" rel="noopener noreferrer">
                <FaLinkedin size={20} title="LinkedIn" aria-hidden="true" />
              </a>
            </div>
